...
TODO: Refactor legacy tools (e.g. DispatchSecureMessage, fetch_post) to use tokio::task::block_in_place for async tool wrappers instead of creating a new runtime, to prevent headless worker crashes
