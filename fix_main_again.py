...
content = content.replace(
    "runtime::fleet_health::evaluate_health_with_ai(runtime::fleet_health::evaluate_health_with_ai(&fleet_status_telemetry, &output.logs).await;fleet_status_telemetry, &output.logs).await;",
