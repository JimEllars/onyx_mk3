...
- **Phase 22 Updates:**
  - Modified `SupportTriageResponse` schema to return `resolution_state` explicitly identifying if an anomaly evaluates as `Deterministic Auto-Heal Staged` or flags as `Tier 4 Action Handoff Routing`
