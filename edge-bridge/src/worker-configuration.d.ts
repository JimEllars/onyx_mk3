/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc ./src/worker-configuration.d.ts` (hash: 7da280d9a542fe38cf9f529ad03c3227)
// Runtime types generated with workerd@1.20260820.1 2026-07-09 nodejs_compat
interface __BaseEnv_Env {
	...
	AI: Ai;
	ASSETS: Fetcher;
	CORE_INGEST_URL: "https://api.axim.us.com/v1/functions/telemetry-ingest";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORE_INGEST_URL" | "ALLOWED_ORIGIN">> {}
}
