/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc ./src/worker-configuration.d.ts` (hash: 0a1bae46f11a2a39c0f46cef18525aa1)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORE_INGEST_URL" | "ALLOWED_ORIGIN" | "DEEPSEEK_MODEL">> {}
}
